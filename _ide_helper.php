...
')
     ...
     */
         ...
         * @static
         */
        public static function getOrCreate($random = true)
        {
                        /** @var \Doinc\Modules\Referral\Referral $instance */
                        return $instance->getOrCreate($random);
        }
                    /**
         ...
         * @static
         */
        public static function newRefPrize()
        {
                        /** @var \Doinc\Modules\Referral\Referral $instance */
                        return $instance->newRefPrize();
        }
                    /**
         * Get the prize that will be received by the referrer for the next referred user.
         *
         * @param \Doinc\Modules\Referral\Models\Interfaces\ReferrableModel $user
         * @return int
         * @static
         */
        public static function computeNewRefPrize($user)
        {
                        /** @var \Doinc\Modules\Referral\Referral $instance */
                        return $instance->computeNewRefPrize($user);
        }
                    /**
         ...
         * @static
         */
        public static function totalRefPrize()
        {
                        /** @var \Doinc\Modules\Referral\Referral $instance */
                        return $instance->totalRefPrize();
        }
                    /**
         ...
         * @static
         */
        public static function redeem($referred_id)
        {
                        /** @var \Doinc\Modules\Referral\Referral $instance */
                        return $instance->redeem($referred_id);
        }
                    /**
         ...
         * @static
         */
        public static function redeemAll()
        {
                        /** @var \Doinc\Modules\Referral\Referral $instance */
                        return $instance->redeemAll();
        }
                    /**
         ...
         * @static
         */
        public static function referralIndexFromPrize($prize)
        {
                        /** @var \Doinc\Modules\Referral\Referral $instance */
