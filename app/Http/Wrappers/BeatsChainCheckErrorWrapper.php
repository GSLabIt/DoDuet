...
use App\Exceptions\BeatsChainDuplicateProposal;
...
class BeatsChainCheckErrorWrapper
{
    private static array $error_map = [
        ...
        "NotOwnedNFT" => BeatsChainNotOwnedNFT::class,
        "VoteNotEnabled" => BeatsChainVoteNotEnabled::class,
        "MissingNft" => BeatsChainMissingNFT::class,
