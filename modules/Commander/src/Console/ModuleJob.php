...
class ModuleJob extends JobMakeCommand
{
    use BladeCompiler;
    ...
    {
        $base_path = resource_path("stubs/modules/src/Jobs");
        $file = $this->getStubName();
        return Blade::render(
    ...
    {
        if ($this->option('sync')) {
            return "{{\$job}}.php.blade.php";
        }

        return "{{\$job_queued}}.php.blade.php";
    }
}
