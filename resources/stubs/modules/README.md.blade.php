...
```json5
{
    ...
    "repositories": [
        ...
        {
            "type": "vcs",
            "url": "git@github.com:Do-inc/laravel-module-{{$kebab}}.git"
        }
    ],
    "require": {
        // ...
        "do-inc/{{$kebab}}-module": "^1.0",
        // ...
    },
    "extra": {
        // ...
...
```bash
php artisan module:install do-inc/{{$kebab}}-module
```
...
## Routes
All routes gets prefixed by `/{{$kebab}}`

| Method | Name                                            | Callback                           | Route                   |
|--------|-------------------------------------------------|------------------------------------|-------------------------|
| `Get`  | `authenticated.{{$snake}}.render.index`         | `ReferralController@index`         | `/`                     |
| `Get`  | `authenticated.{{$snake}}.get.sample`           | `ReferralController@sample`        | `/sample`               |
|        |                                                 |                                    |                         |
| `Post` | `public.{{$snake}}.post.sample`                 | `ReferralController@sample`        | `/sample`               |
| `Post` | `authenticated.{{$snake}}.post.sample`          | `ReferralController@redeemAll`     | `/redeem`               |
