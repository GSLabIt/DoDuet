    ...
    <jet-authentication-card>
        <template #logo>
            <div class="flex flex-col justify-center items-center">
                ...
                <span class="mt-4 text-gray-100 font-semibold text-2xl">Login</span>
            </div>
        </template>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="flex justify-between block mt-4">
                <div>
                    ...
                    <Link :href="route('register')" class="underline text-sm text-fuchsia-300 hover:text-gray-400">
                        Register for free.
                    </Link>
                </div>

                <Link v-if="canResetPassword" :href="route('password.request')"
                      class="text-right whitespace-nowrap underline text-sm text-gray-100 hover:text-gray-400">
