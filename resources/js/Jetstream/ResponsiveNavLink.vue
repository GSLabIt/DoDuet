...
<script>
    ...
    export default defineComponent({
        ...
        computed: {
            classes() {
                return this.active
                    ? 'block pl-3 pr-4 py-2 border-l-4 border-fuchsia-400 text-base font-medium text-fuchsia-700 bg-fuchsia-50 focus:outline-none focus:text-fuchsia-800 focus:bg-fuchsia-100 focus:border-fuchsia-700 transition'
