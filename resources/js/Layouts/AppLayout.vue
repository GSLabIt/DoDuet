                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            <!-- Settings Dropdown -->
                            <div class="ml-3 relative">
                                <jet-dropdown align="right" width="48" content-classes="py-1 bg-purple-100 border border-purple-200 ring-1 ring-purple-200">
                                    <template #trigger>
                                        ...
                                        <span v-else class="inline-flex rounded-md">
                                            <button type="button"
                                                    class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-primary-100 bg-purple-200 hover:text-gray-700 focus:outline-none transition">
                                    ...
                                    <template #content>
                                        <!-- Account Management -->
                                        <div class="block px-4 py-2 text-xs text-secondary-200 font-bold">
                                            Manage Account
                                        </div>
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            <jet-responsive-nav-link :href="route('profile.show')"
                                                     :active="routeMatch('profile.show')">
                                Profile
                            </jet-responsive-nav-link>

                            <jet-responsive-nav-link :href="route('api-tokens.index')"
                                                     :active="routeMatch('api-tokens.index')"
                                                     v-if="$page.props.jetstream.hasApiFeatures">
                                API Tokens
                            </jet-responsive-nav-link>
                            ...
                            <template v-if="$page.props.jetstream.hasTeamFeatures">
                                ...
                                <jet-responsive-nav-link :href="route('teams.show', $page.props.user.current_team)"
                                                         :active="routeMatch('teams.show')">
                                    Team Settings
                                </jet-responsive-nav-link>

                                <jet-responsive-nav-link :href="route('teams.create')"
                                                         :active="routeMatch('teams.create')">
                                    Create New Team
                                </jet-responsive-nav-link>
